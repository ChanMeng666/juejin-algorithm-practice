...
def dfs(people, familiar_matrix, used, current_groups):
    ...
    # Select the first unused person as the group leader
    first = -1
    for i in range(n):
        if not used[i]:
            first = i
